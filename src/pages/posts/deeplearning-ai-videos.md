...
title: 把DeepLearning.AI里面几个没有字幕的课程添加了双语字幕
description: 把DeepLearning.AI里面几个没有字幕的课程添加了双语字幕
pubDate: 2023-12-25T12:00:00Z
imgSrc: '/assets/images/deeplearning-ai-videos.png'
imgAlt: 'deeplearning-ai-videos'
---

我觉得DeepLearning.AI里面的视频质量都非常高，通常课程视频都会提供英文字幕，但是有几个课程不知道为什么到现在还没有添加字幕。所以我就使用[video-translation](https://github.com/169/video-translation)分别给视频添加了中英文双语字幕。如果你需要可以到Youtube或者Bilibili上来看，下面是对应合集(playlist)链接:
